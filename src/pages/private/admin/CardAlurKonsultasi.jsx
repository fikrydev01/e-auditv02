import { ALUR_KONSULTASI } from "../../../constant/data";
...
export default function CardAlurKonslap() {
const roleConfig = {
  ...
  return (
    <div className="w-full bg-white overflow-x-auto py-6 rounded-xl">
      <h2 className="text-center text-xl font-bold mb-6 capitalize">Alur Konsultasi SPI</h2>
      <div className="flex items-center justify-center gap-4 px-8">

                {ALUR_KONSULTASI.map((step, idx) => {
...
>
            ...
            {index < ALUR_KONSULTASI.length - 1 && (
