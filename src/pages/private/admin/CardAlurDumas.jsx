import { ALUR_DUMAS } from "../../../constant/data";
...
export default function CardAlurDumas() {
const roleConfig = {
  ...
  return (
    <div className="w-full bg-white overflow-x-auto py-6 rounded-xl">
      <h2 className="text-center text-xl font-bold mb-6 capitalize">Alur DUMAS</h2>
      <div className="flex items-center gap-4 px-8">

                {ALUR_DUMAS.map((step, idx) => {
