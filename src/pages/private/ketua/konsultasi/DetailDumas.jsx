...
import { API_URL, fetchData, userDetail } from "../../../../utils/api";
...
import ResponseDumas from "./ResponseDumas";

const DetailDumas = ({ dtp, kembali }) => {
  ...
  const [smod, setSmod] = useState('surtug')
  return (
      ...
      <div className="">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col items-start gap-2 mb-4">
            <h1 className="text_h1">Detail Dumas</h1>
