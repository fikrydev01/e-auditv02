...
import { Eye, PlusCircle, Trash2Icon, Check, X, PencilIcon } from "lucide-react";
...
const AuditPdtt = () => {
    ...
    <section className="section-container">
      ...
      {mod == "list" && (
          ...
          <div className="section-body flex flex-col">
            <h2 className="text_h2">LIST AUDIT PDTT SPI</h2>
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            ...
                            {isEditing ? (
                              <input
                                ...
                                onChange={(e) => handleEditChange(e, "tgl_audit")}
                            ...
                            {isEditing ? (
                              <input
                                ...
                                onChange={(e) => handleEditChange(e, "tgl_audit_akhir")}
                                className="w-full px-2 py-1 border rounded-lg text-sm"
                              />
                            ) : (
                              FORMAT_DATE_IND(r.tgl_audit_akhir)
                          ...
                          <td className="px-6 py-4">
                            {isEditing ? (
                              <select
                                type="text"
                                value={editValues?.kode_unit}
                                onChange={(e) => handleEditChange(e, "kode_unit")}
                                className="w-full px-2 py-1 border rounded-lg text-sm"
                              >
                                <option value="">
                                  -- Pilih Unit --
                                </option>
                                {UINJKTUNIT.map((unit, idx) => (
                                  <option key={idx} value={unit.kode}>
                                    {unit.unit}
                                  </option>
                                ))}
  ...
  onChange={(e) => handleEditChange(e, "periode_audit")}
  className="w-full px-2 py-1 border rounded-lg text-sm"
>
  {/* Placeholder */}
