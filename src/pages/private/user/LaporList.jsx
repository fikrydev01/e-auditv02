...
import { FILTER_ALUR_DUMAS_SPI, FILTER_ALUR_DUMAS_USER, FILTER_ALURKONSLAP_USER, FORMAT_DATE_IND, SHORT_TEXT } from "../../../constant/data";
import { ActionButton } from "../../../components/ButtonComp";
import { Eye } from "lucide-react";
import Detail from "./laporan/Detail";
...
const LaporList = () => {
  ...
  return (
    <section className="section-container flex flex-col gap-6">
      {dtp ? <Detail dtp={dtp} kembali={kembali} /> : 
    
      <div className="flex flex-col gap-6">
      <Breadcrumbs title="Data Dumas User" />
      <div className="section-body">
        <h2 className="text_h2">Data Dumas Saya</h2>
                  ...
                  <table className="w-full text-sm text-left text-gray-600">
                    <thead className="text-xs text-gray-100 uppercase bg-gradient-to-r from-blue-500 to-blue-600">
                      <tr>
                        ...
                        <th className="px-6 py-3">Pihak Terlapor</th>
                        <th className="px-6 py-3">Unit Pelapor</th>
                        <th className="px-6 py-3">Tgl Pelaporan</th>
                      ...
                      {datas &&
                        ...
                        .map((r, i) => (
                          ...
                          >
                            ...
                            <td className={`px-6 py-4 capitalize ${r?.status == 'tolak' ? `bg-red-500 text-white` : ``}`}>
                              {r?.status == 'tolak' ? `Ya` : ``}
                            ...
                            <td className="px-6 py-4 uppercase">{r.unit_terlapor}</td>
                            ...
                            <td>
                              ...
                              {/* {r.status_id} */}
                              {FILTER_ALUR_DUMAS_USER(r.status_id)}
