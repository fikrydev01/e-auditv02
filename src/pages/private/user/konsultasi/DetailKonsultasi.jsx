...
import { FILTER_ALUR_KONSULTASI_USER, FILTER_ALURKONSLAP_USER } from "../../../../constant/data";
import {
  API_URL,
  deleteData,
  fetchData,
...
import KonsultasiLog from "../logs/KonsultasiLog";
        ...
        <div className="w-full lg:w-9/12 flex flex-col gap-4">
          ...
          <div className="text-sm">
            ...
            <span className="px-3 py-1 rounded-lg bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
              {FILTER_ALUR_KONSULTASI_USER(datas?.status_id)}
            </span>
          </div>
