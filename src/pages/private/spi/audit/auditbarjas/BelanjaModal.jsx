      ...
      {!invtp ? (
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-end mb-4">
            ...
            className={`text-xs text-white ${showform ?`bg-red-500` : `bg-emerald-500`} px-3 py-2 rounded-md`}
            
            onClick={()=>setShowform(!showform)}>{showform ? `Tutup` : `Tampilkan`} Form Data</button>
          </div>
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div>
                    <h4>Nilai Selisih : {form?.inv_selisih || 0}</h4>
                  </div>
                  <div>
                    <h4>Jumlah Kurang : {form?.inv_jumlah_kurang || 0}</h4>
                  </div>
                  <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                      ...
                      <div className="flex flex-col gap-2">
                    <h4 className="text-lg font-semibold">Analisa Harga Pasar & Invoice</h4>

                  <div>
                    <h4>hp_harga_pasar : {FORMAT_RUPIAH(form?.hp_harga_pasar || 0)}</h4>
                  </div>
                  <div>
                    <h4>hp_harga_maksimal : {FORMAT_RUPIAH(form?.hp_harga_maksimal || 0)}</h4>
                  </div>
                  <div>
                    <h4>hp_selisih mahal/murah : {FORMAT_RUPIAH(form?.hp_selisih || 0)}</h4>
                  </div>
                  <div>
                    <h4>hp_total_selisih : {FORMAT_RUPIAH(form?.hp_total_selisih || 0)}</h4>
                  </div>
