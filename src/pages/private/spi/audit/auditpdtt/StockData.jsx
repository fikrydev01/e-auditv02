...
const StockData = ({dstock, datas, onSave }) => {
  ...
  const handleChange = (index, field, value) => {
    ...
    if (field === "kuantitas_laporan" || field === "kuantitas_opname" || field === "selisih") {
  ...
  return (
    <div className="section-body">
        <h1 className="text_h1">Data Stock Opname</h1>
        ...
        <table className="table-auto w-full rounded-xl">
            ...
            <tr>
                ...
                <th className="px-2 py-1 border">Satuan Auto Sum</th>
                ...
                <tr key={idx} className="hover:bg-gray-50">
                    ...
                    <td className="border px-2 py-1">
                        {/* {row.kode_inti} */}
                                            ...
                                            {renderCell(row, idx, "kode_inti")}
                    </td>
                    <td className="border px-2 py-1">
                        {/* {row.kode_barang} */}

                                            {renderCell(row, idx, "kode_barang")}
                    </td>
